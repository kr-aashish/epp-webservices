...
const HL7V2: string = `MSH|^~\\&|E-Path|Indianapolis Regional Hospital^14D0432237^CLIA|E-Path Plus|OSF|20220707||ORU^R01^ORU^R01|OSF230202105846228|P|2.5.1|||||USA||ENG||2.2
...
const encryptkey: string | null = null; 
const encryptkeysize: number = 0;

const params: HL7Params = {
    HL7V2: HL7V2,  
...
try {
    HL7V2DeIdentifyProcessorAsync(params, (error: Error, result: any) => {
        if (error) {
