...
const ProcessReportAsync = edge.func({
    assemblyFile: 'DLLTEST.dll',
    typeName: 'DLLTEST.HL7V2DeIdentifyReportProcessor',
    methodName: 'ProcessReportAsync'
});

// HL7V2 data
const HL7V2: any = `MSH|^~\\&|E-Path|Indianapolis Regional Hospital^14D0432237^CLIA|E-Path Plus|OSF|20220707||ORU^R01^ORU^R01|OSF230202105846228|P|2.5.1|||||USA||ENG||2.2
...
try{
    ProcessReportAsync(params, (error: any, result: any) => {
        if (error) {
